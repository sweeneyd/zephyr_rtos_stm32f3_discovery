 ...
 * @return #RINGBUF_STATUS enum
 */
RINGBUF_STATUS RingBuf_BytePut(const uint8_t data, RINGBUF_t *rb) {
    if (rb->buf == NULL) return RINGBUF_PARAM_ERR;
 ...
 * @return #RINGBUF_STATUS enum
 */
RINGBUF_STATUS RingBuf_ByteRead(uint8_t *data, RINGBUF_t *rb) {
    if (rb->buf == NULL) return RINGBUF_PARAM_ERR;
 ...
 * @return #RINGBUF_STATUS enum
 */
RINGBUF_STATUS RingBuf_ByteWatch(uint8_t *data, RINGBUF_t *rb) {
